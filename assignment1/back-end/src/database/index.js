...
async function seedData() {
  ...
  await db.film.create({
    ...
    poster: "https://lh3.googleusercontent.com/Pe0VratJbEpfPC0NAkblOPlbp4KIb39YbjtSNQcAJntX2N7UBN61i1ry9s1OIhB-iCc-TlwcRWc"
  });
  await db.film.create({
    title: "Scooby-Doo 2",
    rating: 0,
    releaseDate: 2023 - 01 - 01,
    description: "The Mystery Inc. gang must save Coolsville from an attack of their past monsters brought to life by an evil masked figure trying to take down the gang.",
    poster: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTc844P4Bpvv_IdvSePn-vNfWOeAhoKLz4Ixw&usqp=CAU"
  });
  await db.film.create({
    title: "Tom and Jerry",
    rating: 0,
    releaseDate: 2023 - 01 - 01,
    description: "Jerry, a small mouse, lives within the walls of a large, New England country home where he's befriended the longtime owners, a loving elderly couple. Their unique, comedic friendship comes to an end after the elderly couple passes on and their house is put up for sale. When a young family moves in, Jerry's determined to scare them away from taking over his home. The family quickly adopts a stray cat, later named Tom, to help rid them of their pest problem. In an epic battle for the house, Tom & Jerry soon discover their growing adoration for the family and must work together to protect them from an outside threat. Through their teamwork, they both learn the ultimate value of family and friendship.",
    poster: "https://variety.com/wp-content/uploads/2023/07/Tom-and-Jerry-Singapore-series-poster.jpg"
  });
  await db.film.create({
    title: "Mr. Bean's Holiday",
    rating: 0,
    releaseDate: 2023 - 01 - 01,
    description: "The hapless Mr. Bean takes a vacation on the French Riviera, where he becomes ensnared in an accidental kidnapping and a case of mistaken identity.",
    poster: "https://occ-0-2773-3934.1.nflxso.net/dnm/api/v6/6gmvu2hxdfnQ55LZZjyzYR4kzGk/AAAABYB8AEl7cQpXqQ_EHHo_Rk5oOxMPWtpOJuAQ8Fl_PuW-_IdLWUw0545mMR1hX9Gf-jQx71Q3YWRnNsgKsNzX2BN1lRidRfnhuJrY.jpg?r=954"
  });
}
